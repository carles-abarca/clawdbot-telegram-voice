...
export class PiperTTS {
   ...
   */
  async synthesizeToBuffer(text: string, sampleRate = 48000): Promise<Buffer> {
   ...
   */
  private async wavToPcm(wavPath: string, sampleRate: number): Promise<Buffer> {
   ...
   */
  async convertForTelegram(inputPath: string): Promise<string> {
